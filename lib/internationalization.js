...
/**
 * An object containing all the existing languages of the utility
 */
const langs = {
  en,
  ru,
...
/**
 * Returns an object containing phrases in the selected language.
 * If given language code does not exist, it will return English dictionary by default.
 *
 * @param {String} lang Language code
 * @returns {Object} Contains translated phrases
 */
